...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item \textbf{Integritatea Algoritmului:} Se verifică prin checksum că nodul Python a rulat versiunea corectă a algoritmului, prevenind execuția unui cod alterat.
        \end{itemize}
    \end{itemize}
\end{itemize}
